...
.. code-block::
	...
	$ head -n 24 file.fastq | grep -E "AACACC|$"
...
.. topic:: Exercise
	...
	List the files in the demux directory, and run the grep command to see the read numbers per file. If you're not sure how to do this, check the solution box below
...
These files contain the sequences for which no index was identified - we’re not interested in them.
